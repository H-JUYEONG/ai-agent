...
5. 한국어로 작성
6. **포맷팅 규칙**: 각 섹션 헤더(예: **💰 가격**, **💻 지원 IDE**) 다음에 반드시 빈 줄을 추가한 후 내용 작성. 헤더와 내용을 같은 줄에 작성하거나 줄바꿈 없이 바로 이어서 작성 금지!
...
**🚨 매우 중요: 각 섹션 헤더와 내용 사이에 반드시 빈 줄을 추가하세요!**
- 섹션 헤더(예: **💰 가격**) 다음에 반드시 빈 줄
- 그 다음에 내용 작성
